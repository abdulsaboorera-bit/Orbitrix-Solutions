...
const servicesData = [
  ...
  },
  {
    ...
    summary:
      'Custom n8n automation workflows that connect your tools, eliminate manual tasks, and streamline operations — from CRM integrations to content pipelines.',
    subtitle: 'Custom n8n Workflows That Automate Your Business Operations',
    description:
      'Orbitrix Solutions builds custom n8n automation workflows that connect your existing tools and eliminate repetitive manual tasks. From CRM integrations and lead routing to content pipelines and data syncing, our n8n automations save businesses 20+ hours per week while reducing errors and improving consistency.',
    benefits: [
      'Custom n8n workflows tailored to your specific business processes',
      'CRM integration and automated lead routing',
      'Content pipeline automation (blog, social media, email)',
      'Data syncing between multiple platforms',
      'Error handling and retry logic for reliability',
      'Monitoring dashboards and alert systems',
      'Ongoing maintenance and optimization',
    ],
    problemsSolved: [
      'Hours wasted on manual data entry between systems',
      'Leads falling through the cracks due to slow response times',
      'Inconsistent content publishing across platforms',
      'Disconnected tools creating data silos',
      'Human errors in repetitive tasks',
      'Staff spending time on tasks that could be automated',
    ],
    internationalValue:
      'For international businesses operating across multiple time zones, n8n automations ensure consistent operations 24/7. Our workflows handle multi-region data routing, timezone-aware scheduling, and cross-platform synchronization.',
    features: [
      { icon: faCogs, label: 'Custom Workflows' },
      { icon: faBrain, label: 'AI Powered' },
      { icon: faRocket, label: 'Fast Setup' },
      { icon: faChartLine, label: 'Scalable' },
    ],
    relatedLinks: [
      { label: 'AI Automation', slug: '/services/ai-automation-services' },
      { label: 'Digital Marketing', slug: '/services/digital-marketing' },
    ...
    faq: [
      {
        ...
        answer: 'n8n is an open-source workflow automation tool that connects different apps and services. Unlike Zapier or Make, n8n can be self-hosted for complete data control, offers more complex logic capabilities, and has no per-task pricing — making it ideal for businesses with high-volume automation needs.',
      },
      {
        question: 'What can n8n automate for my business?',
        answer: 'Common n8n automations include: CRM lead routing, email marketing sequences, social media scheduling, content publishing pipelines, data syncing between tools, invoice processing, customer onboarding workflows, and reporting dashboards. If you repeat a task more than 3 times a week, it can likely be automated.',
      },
      {
        question: 'How long does it take to set up n8n workflows?',
        answer: 'Simple workflows (2-3 app connections) take 1-2 weeks. Complex multi-step automations with AI integration take 3-6 weeks. We start with a discovery call to map your workflows, then build and test each automation before deploying.',
      },
      {
        question: 'Do I need technical knowledge to maintain n8n workflows?',
        answer: 'No. We build the workflows and provide training so your team can make simple changes. For complex modifications, we offer ongoing support plans. n8n also has a visual workflow builder that non-technical users can understand.',
      },
      {
        question: 'How much does n8n automation cost?',
        answer: 'Simple workflow setups start at $2,000-$5,000. Complex multi-workflow systems with AI integration range from $5,000-$15,000. We provide ROI projections showing how quickly the automation pays for itself through time savings.',
      },
      {
        question: 'Can n8n replace Zapier or Make?',
        answer: 'Yes. n8n offers more flexibility, can be self-hosted for data privacy, handles complex logic better, and has no per-task pricing. Many businesses migrate from Zapier/Make to n8n when their automation needs grow beyond basic app connections.',
      },
    ],
  },
];
