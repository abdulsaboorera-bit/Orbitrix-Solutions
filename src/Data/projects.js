...
export const projects = [
  ...
  },
  {
    ...
    heroImage: '/ai-automation-suite.svg',
  ...
  {
    slug: 'ai-voice-agent-salon',
    name: 'AI Voice Agent for Salons',
    url: '#',
    category: 'ai-automation',
    categoryLabel: 'AI Automation',
    status: 'Live',
    thumb: '/ai-voice-agent.svg',
    shortDescription: 'An AI-powered voice agent that answers calls, books appointments, and handles FAQs 24/7 for salons and clinics — reducing missed calls to zero.',
    heroImage: '/ai-voice-agent.svg',
    challenge: 'Salons and clinics were losing 40% of potential bookings due to missed calls during busy hours, after hours, and weekends. Staff couldn\'t answer every call while serving in-person clients.',
    approach: 'We designed a conversational AI voice agent trained specifically for salon and clinic operations. The agent handles appointment booking, rescheduling, service inquiries, pricing questions, and FAQs — all in natural conversation.',
    solution: 'Built a custom AI voice agent using advanced language models and telephony integration. The agent answers calls in a natural, friendly tone, accesses the salon\'s calendar in real-time, books appointments, sends confirmation messages via WhatsApp, and escalates complex queries to staff.',
    results: [
      { metric: '0%', label: 'Missed calls (was 40%)' },
      { metric: '24/7', label: 'Availability' },
      { metric: '3x', label: 'More bookings' },
    ],
    technologies: ['AI Voice Models', 'Telephony API', 'Calendar Integration', 'WhatsApp API', 'Natural Language Processing'],
    testimonial: {
      quote: 'We used to miss so many calls during busy hours. Now the AI answers everything — bookings, reschedules, even pricing questions. Our bookings increased by 3x in the first month.',
      author: 'Salon Client',
      role: 'Business Owner',
    },
    projectDetails: {
      client: 'Salon & Clinic Businesses',
      timeline: '3 weeks',
      industry: 'Beauty & Healthcare',
      deliverables: ['AI Voice Agent', 'Calendar Integration', 'WhatsApp Confirmations', 'Call Analytics Dashboard'],
    },
  },
  {
    ...
    categoryLabel: 'AI Automation',
    status: 'Live',
    thumb: '/ai-whatsapp-chatbot.svg',
    shortDescription: 'A custom AI chatbot for WhatsApp that handles customer inquiries, books appointments, and provides instant responses — powered by your own AI model with custom API key integration.',
    heroImage: '/ai-whatsapp-chatbot.svg',
    challenge: 'Businesses were spending hours manually responding to WhatsApp messages. Customers expected instant replies but staff could only handle a few conversations at a time.',
    approach: 'We built a custom AI chatbot that integrates directly with WhatsApp Business API. Unlike generic chatbots, this uses the business\'s own AI model and API key, giving full control over responses and data.',
    solution: 'Developed a custom AI chatbot with API key integration that processes WhatsApp messages in real-time. The bot understands context, handles multi-turn conversations, books appointments, answers FAQs, and seamlessly hands off to human agents when needed.',
    results: [
      { metric: '< 5s', label: 'Average response time' },
      { metric: '80%', label: 'Queries handled automatically' },
      { metric: '24/7', label: 'Customer support' },
    ],
    technologies: ['Custom AI Models', 'WhatsApp Business API', 'API Key Integration', 'NLP', 'Conversation Flow Design'],
    testimonial: {
      quote: 'Our customers get instant answers on WhatsApp any time of day. The chatbot handles most inquiries perfectly and only escalates complex issues to our team.',
    ...
    projectDetails: {
      ...
      deliverables: ['Custom AI Chatbot', 'WhatsApp Integration', 'Conversation Analytics', 'Human Handoff System'],
    },
  },
  {
    slug: 'ai-email-autoresponder',
    name: 'AI Email Auto-Responder',
    url: '#',
    category: 'ai-automation',
    categoryLabel: 'AI Automation',
    status: 'Live',
    thumb: '/ai-email-autoresponder.svg',
    shortDescription: 'An intelligent email system that automatically detects email intent, routes messages to the right department, and sends personalized auto-replies — all powered by AI.',
    heroImage: '/ai-email-autoresponder.svg',
    challenge: 'Businesses received dozens of emails daily that needed manual sorting, routing, and responding. Important emails got lost, responses took hours, and customers grew frustrated with slow reply times.',
    approach: 'We built an AI email processing system that reads incoming emails, understands the intent and urgency, categorizes them, routes to the correct department, and generates personalized auto-replies.',
    solution: 'Developed an AI email agent that parses incoming emails, classifies them by intent (sales, support, billing, general), generates contextual auto-replies, forwards to the right department, and tracks response times. The system learns from patterns to improve accuracy over time.',
    results: [
      { metric: '< 30s', label: 'Auto-reply time (was 4 hrs)' },
      { metric: '95%', label: 'Correct routing accuracy' },
      { metric: '60%', label: 'Reduction in support tickets' },
    ],
    technologies: ['AI Language Models', 'Email Parsing', 'Intent Classification', 'Auto-Reply Generation', 'Department Routing'],
    testimonial: {
      quote: 'Emails that used to sit unanswered for hours now get instant auto-replies and route to the right person automatically. Our response time went from 4 hours to under 30 seconds.',
      author: 'Business Client',
      role: 'Office Manager',
    },
    projectDetails: {
      ...
      timeline: '2 weeks',
      industry: 'Multi-Industry',
      deliverables: ['AI Email Parser', 'Intent Classification', 'Auto-Reply System', 'Department Router', 'Analytics Dashboard'],
    },
  },
  {
    slug: 'ai-blog-autopublisher',
    name: 'AI Blog Auto-Publisher',
    url: '#',
    category: 'ai-automation',
    categoryLabel: 'AI Automation',
    status: 'Live',
    thumb: '/ai-blog-autopublisher.svg',
    shortDescription: 'An n8n-powered automation that generates SEO-optimized blog posts using AI and automatically publishes them to your website — hands-free content marketing.',
    heroImage: '/ai-blog-autopublisher.svg',
    challenge: 'Creating and publishing blog content consistently was time-consuming. Businesses knew content marketing was important but couldn\'t keep up with the demands of regular publishing.',
    approach: 'We built an n8n workflow that automates the entire blog publishing pipeline — from keyword research and content generation to formatting, SEO optimization, and publishing.',
    solution: 'Developed an n8n automation pipeline that: researches trending topics and keywords, generates SEO-optimized blog content using AI, formats with proper headings and structure, adds internal links and CTAs, and auto-publishes to the website on a scheduled basis.',
    results: [
      { metric: '30+', label: 'Blog posts per month' },
      { metric: '10x', label: 'Faster than manual writing' },
      { metric: '200%', label: 'Increase in organic traffic' },
    ],
    technologies: ['n8n', 'AI Content Generation', 'SEO Optimization', 'WordPress/CMS API', 'Scheduled Publishing', 'Keyword Research'],
    testimonial: {
      quote: 'We went from publishing 2 blogs a month to 30+ — all SEO-optimized and auto-published. Our organic traffic tripled in 3 months.',
      author: 'Content Team',
      role: 'Marketing Director',
    },
    projectDetails: {
      client: 'Content-Driven Businesses',
      timeline: '2 weeks',
      industry: 'Multi-Industry',
      deliverables: ['n8n Workflow', 'AI Content Pipeline', 'SEO Optimizer', 'Auto-Publisher', 'Content Calendar'],
    },
  },
  {
    slug: 'ai-social-media-poster',
    name: 'AI Social Media Auto-Poster',
    url: '#',
    category: 'ai-automation',
    categoryLabel: 'AI Automation',
    status: 'Live',
    thumb: '/ai-social-media-poster.svg',
    shortDescription: 'An AI-powered system that generates engaging social media content with captions, hashtags, and descriptions — then auto-publishes across Facebook, Instagram, LinkedIn, and more.',
    heroImage: '/ai-social-media-poster.svg',
    challenge: 'Managing social media across multiple platforms was a full-time job. Creating engaging content, writing captions, researching hashtags, and posting at optimal times consumed hours every week.',
    approach: 'We designed an end-to-end AI automation that handles everything from content creation to scheduling and publishing across all major social platforms.',
    solution: 'Built an AI content pipeline that researches trending topics, generates platform-specific posts with captions and hashtags, creates visual content suggestions, schedules posts at optimal engagement times, and auto-publishes to connected social accounts.',
    results: [
      { metric: '120+', label: 'Posts per month' },
      { metric: '5x', label: 'More engagement' },
      { metric: '95%', label: 'Posting consistency' },
    ],
    technologies: ['AI Content Generation', 'Social Media APIs', 'Automated Scheduling', 'Hashtag Optimization', 'Trend Analysis'],
    testimonial: {
      quote: 'Our social media presence went from sporadic to consistent and engaging. The AI generates better content than we did manually, and it never misses a posting schedule.',
    ...
    projectDetails: {
      ...
      timeline: '3 weeks',
      industry: 'Multi-Industry',
      deliverables: ['AI Content Generator', 'Multi-Platform Publisher', 'Hashtag Optimizer', 'Scheduling System', 'Analytics Dashboard'],
    },
  },
];
